export const ELEVATE_SECTION = {
  ...
  highlights: [
    { label: "Stock items", value: "250+", detail: "Ready for immediate shipping" },
    { label: "Tooled profiles", value: "40,000+", detail: "For custom applications" },
    { label: "Cost savings", value: "70%", detail: "Less than radius wood millwork" },
  ],
} as const;
